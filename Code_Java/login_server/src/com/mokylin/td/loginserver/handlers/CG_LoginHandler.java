...
public class CG_LoginHandler implements IClientMsgHandler<LoginMessage.CGLoginNew> {


    @Override
    public void handle(IClientSession session, LoginMessage.CGLoginNew cgLoginNew) {
