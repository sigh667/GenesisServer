...
public class TimeUtils {
     ...
     * @return
     */
    public static boolean isCurrentTimeBetween(TimeService timeService, Timestamp startTime,
            Timestamp endTime) {
     ...
     * @return
     */
    public static boolean canDoMonthlyResetOp(long milliSecondsA, long milliSecondsB,
            LocalTime resetTime) {
        long resetMillisOfDay = resetTime.getMillisOfDay();
        return !(new YearMonth(milliSecondsA - resetMillisOfDay)
                .equals(new YearMonth(milliSecondsB - resetMillisOfDay)));
    }
     ...
     * @return
     */
    public static boolean canDoDailyResetOp(long currentTime, long lastOpTime,
            LocalTime resetTime) {
        long resetMillisOfDay = resetTime.getMillisOfDay();
        return !(new LocalDate(currentTime - resetMillisOfDay)
                .isEqual(new LocalDate(lastOpTime - resetMillisOfDay)));
    }
