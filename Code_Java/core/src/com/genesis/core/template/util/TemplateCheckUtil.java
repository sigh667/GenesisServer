package com.genesis.core.template.util;
...
public class TemplateCheckUtil {
     ...
     */
    public static void isSequenceTemplate(Map<Integer, ? extends TemplateObject> templateMap,
            int startIndex, int endIndex, String errorMsg) {
