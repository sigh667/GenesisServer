 ...
 *
 */
public class TransactionOpImpl extends AbstractTransactionOp implements ITransactionOp,
    ...
    public TransactionOpImpl(JedisPool jedisPool, ISerializerPool serializerPool,
    ...
    public IWatchedTransactionOp watch(String... keys) {
        if (keys == null || keys.length == 0) {
            throw new RedisException("Can not watch empty keys!");
        }
