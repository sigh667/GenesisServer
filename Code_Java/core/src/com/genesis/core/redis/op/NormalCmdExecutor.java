 ...
 *
 */
public class NormalCmdExecutor implements IRedisCmdExecutor,
        IRealExecuteRedisCommand<SingleRedisCmd<?>, IRedisResponse<?>> {
    ...
    NormalCmdExecutor(JedisPool jedisPool, ISerializerPool serializerPool,
    ...
    public IRedisResponse<?> realExec(SingleRedisCmd<?> func) {
        ...
        try {
            ...
            return RedisResponse
                    .success(func.processResult(jedisClient.getOne(), jedisClient, serializer));
        } catch (Exception e) {
