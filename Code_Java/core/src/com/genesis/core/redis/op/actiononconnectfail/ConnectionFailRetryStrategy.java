...
import com.genesis.core.redis.RedisConstants;
import com.genesis.core.redis.op.IRealExecuteRedisCommand;
...
public class ConnectionFailRetryStrategy {
     ...
     * @return
     */
    public static <P, R extends IRedisResponse<?>> R exec(IRealExecuteRedisCommand<P, R> execImpl,
                                                          P func, IActionOnCannotConnectRedis actionOnFail) {
