...
public class ScheduledProcessUnit extends ProcessUnit {
    ...
    public void scheduleAtFixedRate(final Runnable task, long initDelay, long period,
            TimeUnit timeUnit) {
    ...
    public <T> ScheduledFuture<Optional<T>> schedule(final Callable<T> task, long delay,
            TimeUnit timeUnit) {
