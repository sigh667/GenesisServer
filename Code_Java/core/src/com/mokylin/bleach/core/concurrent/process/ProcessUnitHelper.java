...
public class ProcessUnitHelper {
    ...
    public static ProcessUnit createFixedProcessUnit(final String threadName, final int threadNum) {
        ...
        return new ProcessUnit(threadName,
                Executors.newFixedThreadPool(threadNum, new ThreadFactory() {
                    @Override
                    public Thread newThread(Runnable r) {
                        return new Thread(r, threadName);
                    }
    ...
    public static ScheduledProcessUnit createScheduledProcessUnit(final String threadName,
            final int threadNum) {
        checkNotNull(threadName, "Can not create a Scheduled Process Unit named NULL!");
        return new ScheduledProcessUnit(threadName,
                Executors.newScheduledThreadPool(threadNum, new ThreadFactory() {
                    @Override
                    public Thread newThread(Runnable r) {
                        return new Thread(r, threadName);
                    }
