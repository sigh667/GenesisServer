...
public class HibernateDBService {
     ...
     * @param resourceNames
     */
    public HibernateDBService(String packageName, Properties p, URL hibernateCfgXmlUrl,
        ...
        if (packageName != null && !packageName.isEmpty()) {
            Set<Class<?>> handlerSet =
                    PackageUtil.getPackageClasses(packageName, new Predicate<Class<?>>() {
                        @Override
     ...
     */
    public <T extends BaseEntity> T getById(final Class<T> entityClass, final Serializable id)
            throws DataAccessException {
     ...
     * @throws DataAccessException
     */
    public <T extends BaseEntity, IdType extends Serializable> List<T> getByIdBatch(
            final Class<T> entityClass, final List<IdType> idList) throws DataAccessException {
     ...
     * @throws DataAccessException
     */
    public <T extends BaseEntity> List<T> getAll(final Class<T> entityClass)
            throws DataAccessException {
     ...
     * @throws DataAccessException
     */
    public Serializable[] saveBatch(final List<BaseEntity> allToSaveList)
            throws DataAccessException {
        return transTemplate.doGuestCall(new HibernateCallback<Serializable[]>() {
            @Override
            public Serializable[] doCall(Session session) {
     ...
     * @throws DataAccessException
     */
    public int queryForUpdate(final String queryName, final String[] paramNames,
    ...
    public <T extends BaseEntity> List<T> findByNamedQueryAndNamedParamAllT(
            final Class<T> entityClass, final String queryName, final String[] paramNames,
            final Object[] values) {
     ...
     * @return
     */
    public <T extends BaseEntity> List<T> findBySqlQueryAndParamAllT(final Class<T> entityClass,
