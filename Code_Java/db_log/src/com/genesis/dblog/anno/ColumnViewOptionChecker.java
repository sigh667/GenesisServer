package com.genesis.dblog.anno;
    ...
    public static LinkedHashMap<Integer, String> check(ColumnView view) {
        ...
        if (view.optionName() != null && view.optionValue() != null &&
            ...
            if (view.search() != null && !"".equals(view.search()) && !"=".equals(view.search())) {
                System.out.println(
                        "view.search() = " + view.search() + "-----value = " + view.value());
            ...
            if (Sets.newHashSet(ArrayUtils.toObject(view.optionValue())).size() !=
                    view.optionValue().length) {
