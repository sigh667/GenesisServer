package com.genesis.test.core.config;

import com.google.common.collect.Table;

import com.genesis.core.config.ConfigBuilder;
import com.genesis.core.config.exception.ConfigBuildException;
import com.genesis.test.core.config.mock.MapConfig;
import com.genesis.test.core.config.mock.TableConfig;
import com.genesis.test.core.config.mock.TestClass;
import com.genesis.test.core.config.mock.TestEnum;
import com.genesis.test.core.config.serverconfig.GameServerConfig;
...
public class ConfigBuilderTest {
    ...
    public void config_object_should_have_the_same_content_with_config_file() {
        GameServerConfig config =
                ConfigBuilder.buildConfigFromFileName("config/server.conf", GameServerConfig.class);
    ...
    public void all_field_in_config_object_should_have_the_default_value() {
        GameServerConfig config = ConfigBuilder
                .buildConfigFromFileName("config/server2.conf", GameServerConfig.class);
    ...
    public void table_field_should_be_a_table() {
        TableConfig conf =
                ConfigBuilder.buildConfigFromFileName("config/table.conf", TableConfig.class);
