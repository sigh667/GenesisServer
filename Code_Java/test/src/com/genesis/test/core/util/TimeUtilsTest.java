package com.genesis.test.core.util;
...
public class TimeUtilsTest {
    ...
    public void canDoDailyResetOp_should_act_correctly() { //偷个懒
        ...
        assertThat(TimeUtils
                        .canDoDailyResetOp(crB.getTimeInMillis(), lastOpTime.getTimeInMillis(), reset1),
                is(true));

        //---|-----21--reset2---18:05---------22:01----|---22-------------------
        assertThat(TimeUtils
                        .canDoDailyResetOp(crB.getTimeInMillis(), lastOpTime.getTimeInMillis(), reset2),
                is(false));

        //---|-----21--------------18:05---reset1------|---22---4:01------------
        assertThat(TimeUtils
                        .canDoDailyResetOp(crC.getTimeInMillis(), lastOpTime.getTimeInMillis(), reset1),
                is(true));

        //---|-----21---------------------18:05--------|---22---4:01----reset2--
        assertThat(TimeUtils
                        .canDoDailyResetOp(crC.getTimeInMillis(), lastOpTime.getTimeInMillis(), reset2),
                is(false));

        //---|-----21--------------18:05---reset1------|---22-----------10:01---
        assertThat(TimeUtils
                        .canDoDailyResetOp(crD.getTimeInMillis(), lastOpTime.getTimeInMillis(), reset1),
                is(true));

        //---|-----21---------------------18:05--------|---22--reset2---10:01---
        assertThat(TimeUtils
                        .canDoDailyResetOp(crD.getTimeInMillis(), lastOpTime.getTimeInMillis(), reset2),
                is(true));

        //下面的间隔过月和过年了
        assertThat(TimeUtils
                        .canDoDailyResetOp(crE.getTimeInMillis(), lastOpTime.getTimeInMillis(), reset1),
                is(true));
        assertThat(TimeUtils
                        .canDoDailyResetOp(crE.getTimeInMillis(), lastOpTime.getTimeInMillis(), reset2),
                is(true));
        assertThat(TimeUtils
                        .canDoDailyResetOp(crF.getTimeInMillis(), lastOpTime.getTimeInMillis(), reset1),
                is(true));
        assertThat(TimeUtils
                        .canDoDailyResetOp(crF.getTimeInMillis(), lastOpTime.getTimeInMillis(), reset2),
                is(true));
    }
    ...
    public void canDoMonthlyResetOp_should_act_correctly() { //再偷个懒
        ...
        //----10.21----|----11.1 4:59:59-------
        assertThat(TimeUtils
                        .canDoMonthlyResetOp(crB.getTimeInMillis(), lastOpTime.getTimeInMillis(), reset),
                is(false));
        //----10.21-------10.22-------
        assertThat(TimeUtils
                        .canDoMonthlyResetOp(crC.getTimeInMillis(), lastOpTime.getTimeInMillis(), reset),
                is(false));
        //----10.21----|----11.1 5:00:00-------
        assertThat(TimeUtils
                        .canDoMonthlyResetOp(crD.getTimeInMillis(), lastOpTime.getTimeInMillis(), reset),
                is(true));
        //----10.21----|----11.21-------
        assertThat(TimeUtils
                        .canDoMonthlyResetOp(crE.getTimeInMillis(), lastOpTime.getTimeInMillis(), reset),
                is(true));
        //跨年
        assertThat(TimeUtils
                        .canDoMonthlyResetOp(crF.getTimeInMillis(), lastOpTime.getTimeInMillis(), reset),
                is(true));

        //----10.01 4:59:59----|----11.1 5:00:00-------
        assertThat(TimeUtils
                        .canDoMonthlyResetOp(crD.getTimeInMillis(), lastOpTime1.getTimeInMillis(), reset),
                is(true));
    }
}
