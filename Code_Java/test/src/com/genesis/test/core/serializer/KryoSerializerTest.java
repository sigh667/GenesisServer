...
import com.genesis.test.core.serializer.mockentity.FinalMessage;
import com.genesis.test.core.serializer.mockentity.ListMessage;
import com.genesis.test.core.serializer.mockentity.Message;
import com.genesis.test.core.serializer.mockentity.Message1;
import com.genesis.test.core.serializer.mockentity.Message2;
import com.genesis.test.core.serializer.mockentity.Message3;
...
public class KryoSerializerTest {
    ...
    private static byte[] serialize(Kryo kryo, Object o) {
        ByteBufOutputStream bbos =
                new ByteBufOutputStream(UnpooledByteBufAllocator.DEFAULT.heapBuffer());
    ...
    private static <T> T deserialize(Kryo kryo, byte[] b, Class<T> type) {
        ...
        ByteBufInputStream bbis =
                new ByteBufInputStream(UnpooledByteBufAllocator.DEFAULT.heapBuffer().writeBytes(b));
    ...
    public void print_the_speed_information_of_kryo_register() {
        Set<Class<?>> classes =
                PackageUtil.getPackageClasses("com.mokylin.bleach", new Predicate<Class<?>>() {
        ...
        System.out.println(
                "register " + classes.size() + " classes need " + spendTime + " milliseconds.");
