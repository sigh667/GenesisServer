package com.genesis.test.dataserver.sqlupdate;
    ...
    public void update_map_should_be_right() throws IOException {
        ...
        treeMap.put(5, new Node(5, null));
        {
            Object temp = PrivateUtil.invoke(new SqlUpdate(), "getUpdateMap",
                    new Class[]{treeSet.getClass(), treeMap.getClass()},
                    new Object[]{treeSet, treeMap});
            @SuppressWarnings("unchecked") TreeMap<Integer, Node> updateMap =
                    (TreeMap<Integer, Node>) temp;
