package com.genesis.test.gameserver.currency;
...
import com.genesis.test.gameserver.battleprop.MockHuman;
...
public class CurrencyTest {
    ...
    public void the_currency_should_behave_correctly() {
        ...
        assertArrayEquals(new Boolean[]{human.isMoneyEnough(Currency.DIAMOND, 500)},
                new Boolean[]{false});
        assertArrayEquals(new Boolean[]{human.isMoneyEnough(Currency.DIAMOND, 350)},
                new Boolean[]{true});
        assertArrayEquals(new Boolean[]{human.isMoneyEnough(Currency.GOLD, 500)},
                new Boolean[]{false});
        assertArrayEquals(new Boolean[]{human.isMoneyEnough(Currency.GOLD, 400)},
                new Boolean[]{true});
