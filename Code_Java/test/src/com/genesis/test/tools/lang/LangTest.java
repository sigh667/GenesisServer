package com.genesis.test.tools.lang;
...
public class LangTest {
    ...
    public void local_lang_file_should_be_created_and_read_successfully() {
        ...
        Map<Integer, String> localLangData = LangUtil.loadLangData(
                Constants.LANG_FILE_PATH + Local_Lang_zh_CN_Generator.LOCAL_ZN_CN_LANG_FILE_NAME);
    ...
    private void createLangConfig(final boolean ignoreModify) {
        ExcelOperation.createExcel(Constants.LANG_FILE_PATH + Constants.CONFIG_FILE_NAME,
    ...
    public void the_zh_CN_lang_file_and_change_footprint_file_should_be_generated_correctly() {
        ...
        // 清空足迹文件
        ExcelOperation.createExcel(Constants.LANG_FILE_PATH + Constants.MODIFY_FOOTPRINT_FILE_NAME,
                new ModifyWorkbookOperation() {
    ...
    public void the_to_translate_file_should_be_generated_correctly() {
        ...
        Map<Integer, String> toTranslateData =
                LangUtil.loadLangData(Language.ja_JP.getToTranslatePath());
