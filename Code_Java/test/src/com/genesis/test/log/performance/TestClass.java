...
public class TestClass {
    ...
    public TestClass(long iEventId, long iWorldId, long iUin, long deEventTime, long dtLoginTime,
            String vClientIp, String vZoneId, long dtCreateTime, long iOnlineTime,
