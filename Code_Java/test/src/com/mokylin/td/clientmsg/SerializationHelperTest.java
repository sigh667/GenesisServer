...
public class SerializationHelperTest {
    ...
    @Test
    public void test_add_and_pop_custom_enum()
            throws UnsupportedEncodingException, NotSupportedException, InstantiationException,
        ...
        for (int i = 0; i < values.length; i++) {
            Object oo =
                    SerializationHelper.customDeserialization(buffer, EnumLoginFailReason.class);
