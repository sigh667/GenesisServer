...
public class UUIDTest {
    ...
    public void uuid_generator_should_generate_sequential_id_from_100() {
        ...
        IUUIDGenerator uuidGenerator =
                UUIDGeneratorFactory.createUUIDGenerator(channelId, serverId, TestType.class, null);
        ...
        Assert.assertArrayEquals(new long[]{101, 102, 103, 104, 105},
                new long[]{uuid1, uuid2, uuid3, uuid4, uuid5});
    }
