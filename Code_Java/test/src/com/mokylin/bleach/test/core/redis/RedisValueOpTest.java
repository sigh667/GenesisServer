...
public class RedisValueOpTest extends AbstractOpTest {
    ...
    @Test
    public void setExpiredBySeconds_should_let_key_expired_after_specific_seconds()
            throws Exception {
        MockEntity me = makeMockEntity();
    ...
    @Test
    public void setExpiredByMilliseconds_should_let_key_expired_after_specific_seconds()
            throws Exception {
        MockEntity me = makeMockEntity();
