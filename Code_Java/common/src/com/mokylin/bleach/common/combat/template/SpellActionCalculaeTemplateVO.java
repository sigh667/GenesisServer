...
public abstract class SpellActionCalculaeTemplateVO extends TemplateObject {
    ...
    public void setAttributeList(
            List<com.mokylin.bleach.common.combat.model.EffectBase> attributeList) {
        if (attributeList == null) {
            throw new TemplateConfigException(this.getSheetName(), this.getId(), 0,
                    "[效果器]attributeList不可以为空");
        }
    ...
    public String toString() {
        return "SpellActionCalculaeTemplateVO[attackRate=" + attackRate + ",strTargetBuffIds=" +
                strTargetBuffIds + ",strCasterBuffIds=" + strCasterBuffIds + ",attributeList=" +
                attributeList + ",]";
