...
public abstract class ShopItemPriceTemplateVO extends TemplateObject {
    ...
    public void setGeneralShopCurrencyType(
            com.mokylin.bleach.common.currency.Currency generalShopCurrencyType) {
        if (generalShopCurrencyType == null) {
            throw new TemplateConfigException(this.getSheetName(), this.getId(), 0,
                    "[普通商店货币类型]generalShopCurrencyType不可以为空");
        }
    ...
    public String toString() {
        return "ShopItemPriceTemplateVO[generalShopCurrencyType=" + generalShopCurrencyType +
                ",generalShopPrice=" + generalShopPrice + ",]";
