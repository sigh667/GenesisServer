...
public abstract class ShopGoodTemplateVO extends TemplateObject {
    ...
    public String toString() {
        return "ShopGoodTemplateVO[shopType=" + shopType + ",sellPosition=" + sellPosition +
                ",storeRoomId=" + storeRoomId + ",baseNum=" + baseNum + ",critRate=" + critRate +
