...
public abstract class DailyRewardElemTemplateVO extends TemplateObject {
    ...
    public void setMultiRewardVipLevel(int multiRewardVipLevel) {
        if (multiRewardVipLevel < 0) {
            throw new TemplateConfigException(this.getSheetName(), this.getId(), 0,
                    "[多倍奖励所需VIP等级]multiRewardVipLevel的值不得小于0");
        }
    ...
    public void setMultiRewardVipRatio(int multiRewardVipRatio) {
        if (multiRewardVipRatio < 1) {
            throw new TemplateConfigException(this.getSheetName(), this.getId(), 0,
                    "[VIP触发的奖励的倍数]multiRewardVipRatio的值不得小于1");
        }
    ...
    public String toString() {
        return "DailyRewardElemTemplateVO[giftId=" + giftId + ",multiRewardVipLevel=" +
                multiRewardVipLevel + ",multiRewardVipRatio=" + multiRewardVipRatio + ",]";
