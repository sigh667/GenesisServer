...
import com.genesis.common.prop.battleprop.propholder.FinalProp;
...
public class BattlePropContainer implements IPropContainer {
    ...
    private final int[][] propsSplitByEffectType =
            new int[PropEffectType.values().length][HeroBattlePropId.values().length];
    ...
    private void calculateFinalProps() {
        for (HeroBattlePropId propId : HeroBattlePropId.values()) {
            final float absValue =
                    propsSplitByEffectType[PropEffectType.Abs.ordinal()][propId.ordinal()];
            final float perValue =
                    propsSplitByEffectType[PropEffectType.Per.ordinal()][propId.ordinal()] /
                            BATTLE_DIV_BASE;
