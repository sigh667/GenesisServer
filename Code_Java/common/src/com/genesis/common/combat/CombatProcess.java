...
import com.genesis.common.combat.template.CombatTemplate;
...
public class CombatProcess {
    ...
    public void start() {
         ...
         */
        //依据战斗类型，允许的最大回合数不同
        CombatTemplate template = GlobalData.getTemplateService()
                .get(combatStatus.getCombatType().getIndex(), CombatTemplate.class);
