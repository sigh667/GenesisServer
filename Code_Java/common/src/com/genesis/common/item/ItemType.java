...
public enum ItemType {
    ActiveConsumables, PassiveConsumables, EquipmentPieces, EquipmentMaterialPieces, Equipment,
    EquipmentMaterial, Soulstone,;
    ...
    static {
        ...
        if (enumNum > MAX_ENUM_NUM) {
            throw new RuntimeException(
                    String.format("ItemType枚举数量【%d】超过最大数量【%d】", enumNum, MAX_ENUM_NUM));
        }
