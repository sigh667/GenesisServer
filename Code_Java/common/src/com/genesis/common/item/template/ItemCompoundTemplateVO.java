...
public abstract class ItemCompoundTemplateVO extends TemplateObject {
	...
	/** 合成需要的物品模板ID */
	@ExcelCollectionMapping(clazz = com.genesis.common.item.template.ItemCompoundMaterial[].class, collectionNumber = "2,3;4,5;6,7;8,9")
	protected com.genesis.common.item.template.ItemCompoundMaterial[] compoundMaterials;
	...
	public com.genesis.common.item.template.ItemCompoundMaterial[] getCompoundMaterials() {
		return this.compoundMaterials;
	}

	public void setCompoundMaterials(com.genesis.common.item.template.ItemCompoundMaterial[] compoundMaterials) {
