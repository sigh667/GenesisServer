...
public abstract class AbstractRedisKey<IdType extends Serializable, T extends EntityWithRedisKey<?>>
        implements IRedisKey<IdType, T> {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(serverId == o.getServerId() ||
                (serverId != null && serverId.equals(o.getServerId())))) {
            return false;
        }
