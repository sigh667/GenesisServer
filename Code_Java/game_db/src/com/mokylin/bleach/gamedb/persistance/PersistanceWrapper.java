...
public class PersistanceWrapper {
    ...
    public PersistanceWrapper(
            IObjectInSql<? extends Serializable, ? extends EntityWithRedisKey<?>> sqlObject) {
    ...
    public boolean equals(Object obj) {
        ...
        IObjectInSql<? extends Serializable, ? extends EntityWithRedisKey<?>> otherSO =
                other.getSqlObject();
        ...
        if (otherId == sqlObject.getDbId() ||
                (otherId != null && otherId.equals(sqlObject.getDbId()))) {
            return true;
        } else {
            return false;
        }
