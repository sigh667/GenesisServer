...
public class ServerDBManager {
    ...
    public ServerDBManager(int originalServerId, int currentServerId, IRedis iRedis) {
        ...
        readThreadExecutor = ProcessUnitHelper.createSingleProcessUnit(
                originalServerId + "区read线程，当前隶属于" + currentServerId + "区");
        mainThreadExecutor = ProcessUnitHelper.createSingleProcessUnit(
                originalServerId + "区main线程，当前隶属于" + currentServerId + "区");
        writeThreadExecutor = ProcessUnitHelper.createSingleProcessUnit(
                originalServerId + "区write线程，当前隶属于" + currentServerId + "区");
    }
