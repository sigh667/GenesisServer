...
public enum InventoryType {
    ...
    Fragment {
                ...
                @Override
                public boolean contains(ItemType itemType) {
                    if (itemType == ItemType.EquipmentMaterialPieces ||
                            itemType == ItemType.EquipmentPieces) {
                        return true;
                    }
                    return false;
                }
    ...
    Consumables {
                ...
                @Override
                public boolean contains(ItemType itemType) {
                    if (itemType == ItemType.ActiveConsumables ||
                            itemType == ItemType.PassiveConsumables) {
                        return true;
                    }
                    return false;
                }
