...
import com.genesis.robot.item.view.model.ItemModel;
...
public class InventoryFrame extends JFrame {
    ...
    private void onSell() {
        ...
        //先写成全卖，稍候做选卖出数量的面板
        CGItemSell msg = CGItemSell.newBuilder().setTemplateId(item.getTemplateId())
                .setAmount(item.getOverlap()).build();
