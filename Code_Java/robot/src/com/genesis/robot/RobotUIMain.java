package com.genesis.robot;

import com.genesis.robot.core.net.Connect;
...
import com.genesis.robot.ui.loading.LoadingDlgType;
...
public class RobotUIMain {
    ...
    private void initialize() {
        ...
        groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(Alignment.TRAILING).addGroup(
                groupLayout.createSequentialGroup().addGap(152)
        ...
        groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING)
                .addGroup(Alignment.TRAILING,
                        groupLayout.createSequentialGroup().addContainerGap(127, Short.MAX_VALUE)
                                .addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
                                        .addComponent(textField, GroupLayout.PREFERRED_SIZE,
                                                GroupLayout.DEFAULT_SIZE,
                                                GroupLayout.PREFERRED_SIZE)
                                        .addComponent(btnNewButton)).addGap(114)));
    ...
    public void centerScreen() {
        ...
        frmBleach.setLocation((dim.width - abounds.width) / 2, (dim.height - abounds.height) / 2);
