...
public class GCMsgFunctionService {
    ...
    public GCMsgFunctionService(Map<Integer, IGCMsgFunc<GeneratedMessage>> funcs,
            Map<Integer, Parser<? extends GeneratedMessage>> parsers) {
        funcMap = ImmutableMap
                .copyOf(checkNotNull(funcs, "MsgFunctionService can not init with null funcs!"));
        paserMap = ImmutableMap.copyOf(checkNotNull(parsers,
