package com.genesis.tools.loggenerator.util;
...
import com.genesis.tools.loggenerator.component.LogField;
import com.genesis.tools.loggenerator.component.LogTemplate;
import com.genesis.tools.loggenerator.component.SpecialArg;
...
public class ConvertToTemplateEntity {
    ...
    private static LogEntityForTemplate convertToTemplateEntity(LogTemplate logTemplate) {
        ...
        for (SpecialArg specialArg : specialArgs) {
            ...
            if (specialArg.fromType.equals(ServerGlobals.class)) {
                continue;
            }
        ...
        for (int i = 0; i < logTemplate.fields.size(); i++) {
            ...
            if (isSpecialArg(fieldName)) {
                ...
                if (!isDate) {
                    ...
                    setterB.append("TimeUtils.convertToDateString(").append(fieldName).append(")");
                }
            }
