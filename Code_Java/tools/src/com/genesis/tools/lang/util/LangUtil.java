package com.genesis.tools.lang.util;
...
public class LangUtil {
     ...
     * @param path
     */
    public static void createLangExcel(final List<LangItem> langItemList, final int version,
            String path) {
     ...
     */
    public static Map<Integer, String> loadNewData()
                    ...
                    if (anno != null) {
                        ...
                        if (data.containsKey(id)) {
                            throw new RuntimeException(
                                    "LangConstants 文件中包含有重复的key！[key:" + id + ", content:" +
                                            anno.value() + "]");
                        }
    ...
    public static List<ChangeFootprint> loadAllChangeFootprints() {
        ...
        ExcelOperation.loadExcel(Constants.LANG_FILE_PATH + Constants.MODIFY_FOOTPRINT_FILE_NAME,
                Constants.CHANGE_FOOTPRINT, new LoadRowOperation() {
     ...
     * @return
     */
    public static List<LangItem> getToTranslateLangItems(final int lanVersion,
            final int zh_CNVersion) {
        final List<ChangeFootprint> allChangeFootprints = loadAllChangeFootprints();

        Collection<ChangeFootprint> changeFpCollection =
                Collections2.filter(allChangeFootprints, new Predicate<ChangeFootprint>() {
