...
public enum Language {
    ...
    zh_CN("zh_CN\\lang.xlsx", "简体中文"), ja_JP("ja_JP\\lang.xlsx", "日文"),
    de_DE("de_DE\\lang.xlsx", "德语"), en_US("en_US\\lang.xlsx", "英语"),
    fr_FR("fr_FR\\lang.xlsx", "法语"), zh_TW("zh_TW\\lang.xlsx", "繁体中文");
    ...
    public String getToTranslatePath() {
        return Constants.LANG_FILE_PATH + path.substring(0, path.length() - 8) + this.toString() +
                "_to_translate.xlsx";
    }
