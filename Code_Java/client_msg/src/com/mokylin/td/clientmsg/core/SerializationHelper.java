...
public class SerializationHelper {
    ...
    public static void writeU29Int(ByteBuf __bytes, int value) {
        if (value < minU29Int || value > maxU29Int) {
            throw new IllegalArgumentException(
                    "writeU29Int，传入的参数超过范围【-(2^28次方) 到 2^28次方-1】！参数为==" + value);
        }
    ...
    public static void writeUTF(ByteBuf __bytes, String __value)
            throws UnsupportedEncodingException {
    ...
    public static void customSerialization(ByteBuf __targetBytes, Object __object)
            throws NotSupportedException, UnsupportedEncodingException {
    ...
    public static Object customDeserialization(ByteBuf __serializationBytes, Class<?> clazz)
        ...
        if (clazz == null) {
            throw new IllegalArgumentException(
                    "customDeserialization(ByteBuf __serializationBytes, Class<?> clazz) clazz can not be null!");
        }
        //        if(clazz == null)
        //        {
    ...
    private static void writeAMF3Object(ByteBuf __bytes, Object __object)
            throws NotSupportedException {
    ...
    private static Object ReadAMF3Data(ByteBuf __bytes, AMF3SerializationDefine typeCode)
            throws NotSupportedException {
        if (typeCode == null) {
        ...
        switch (typeCode) {
            ...
            case Dictionary: {
                ...
                throw new NotSupportedException(
                        "NotSupported AMF3SerializationDefine == " + typeCode.toString());
            }
            default:
                throw new NotSupportedException(
                        "UnKnown AMF3SerializationDefine == " + typeCode.toString());
        }
        return returnResult;
    }
     ...
     */
    public static boolean readMask(BitArray __mask__, int index)
            throws ArrayIndexOutOfBoundsException {
    ...
    public static List<? extends ISerializationDataBase> customDeserializationVector(
            ByteBuf __bytes, Class<? extends ISerializationDataBase> clazz)
            throws InstantiationException, IllegalAccessException, UnsupportedEncodingException,
            NotSupportedException {
    ...
    private enum AMF3SerializationDefine {
        Undefined, Null, BooleanFalse, BooleanTrue, Int, Number, String, XMLDoc, Date, Array,
        Object, XML, ByteArray, VectorInt, VectorUint, VectorNumber, VectorObject, Dictionary;
