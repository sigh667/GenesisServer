...
public class ClientMsgHandleUtil {
     ...
     */
    public static Map<Integer, IClientMsgHandle<ICommunicationDataBase>> buildMsgHandle(
        ...
        Set<Class<?>> funcClassSet =
                PackageUtil.getSubClass(clisentMsgFuncsPackage, IClientMsgHandle.class);
        ...
        for (Class<?> each : funcClassSet) {
            ...
            Class<?> msgTypeClass =
                    GenericityUtil.extractFirstGenericType(each, IClientMsgHandle.class);
            ...
            @SuppressWarnings("unchecked") IClientMsgHandle<ICommunicationDataBase> eachHandler =
                    (IClientMsgHandle<ICommunicationDataBase>) each.newInstance();
