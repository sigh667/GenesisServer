...
public class FloodByteAttackFilter extends ChannelInboundHandlerAdapter {
    ...
    /**每分钟的流量记录器*/
    private FloodByteRecorder floodByteRecorder60 =
            new FloodByteRecorder(60 * TimeUtils.SECOND, 128 * 1024);
    /**每2秒的流量记录器*/
    private FloodByteRecorder floodByteRecorder2 =
            new FloodByteRecorder(2 * TimeUtils.SECOND, 48 * 1024);
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        if (FloodConstants.Inst.isOpenFloodFilter() &&
                !FloodFilterService.Inst.isInWhiteList(hostString) && msg instanceof ByteBuf) {
