...
public enum FloodFilterService {
    ...
    private final long[] forbiddenMS =
            {5 * TimeUtils.MIN, 10 * TimeUtils.MIN, 30 * TimeUtils.MIN, 60 * TimeUtils.MIN,
                    3 * TimeUtils.HOUR, 6 * TimeUtils.HOUR, 12 * TimeUtils.HOUR,
                    24 * TimeUtils.HOUR, 2 * TimeUtils.DAY, 4 * TimeUtils.DAY, 7 * TimeUtils.DAY,
                    2 * 7 * TimeUtils.DAY};
    /**IP白名单*/
