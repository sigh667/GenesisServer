...
public class GameScheduledProcessUnit extends GameProcessUnit {
     ...
     * @param task
     */
    public void schedule(FiniteDuration initialDelay, FiniteDuration interval,
            final Runnable task) {
     ...
     * @return
     */
    public Cancellable scheduleOnce(ActorRef executeActor, Object msg, long delay,
            TimeUnit timeUnit) {
        return this.scheduler
                .scheduleOnce(FiniteDuration.create(delay, timeUnit), executeActor, msg,
                        this.getExecutionContext(), ActorRef.noSender());
    }
}
