...
public class ServerInitComplete {
    ...
    public ServerInitComplete(Map<Class<? extends UntypedActor>, ActorRef> map,
            ServerGlobals sGlobals, ServerInitObject serverInitObject) {
        this.map = ImmutableMap
                .copyOf(checkNotNull(map, "ServerInitComplete can not be created with null map!"));
        this.sGlobals = checkNotNull(sGlobals,
                "ServerInitComplete can not be created with null server globals!");
