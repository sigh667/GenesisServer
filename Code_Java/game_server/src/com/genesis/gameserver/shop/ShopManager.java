...
public class ShopManager {
    ...
    private void scheduleTimeEvent() {
        for (Shop shop : this.shops.values()) {
            ...
            if (shop.isOpenForever()) {
                ...
                human.getTimeAxis()
                        .scheduleEventOnThisTime(new ShopCloseTask(shop), shop.getCloseTime());
            }
        }
    }
    ...
    public Shop enableShop(ShopType shopType) {
        ...
        if (shop == null) {
            ...
            long shopUUID =
                    this.human.getServerGlobals().getUUIDGenerator().getNextUUID(UUIDType.Shop);
