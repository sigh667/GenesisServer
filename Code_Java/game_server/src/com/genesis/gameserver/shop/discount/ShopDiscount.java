package com.genesis.gameserver.shop.discount;
...
public class ShopDiscount extends ObjectInSqlImplNoCache<Long, ShopDiscountEntity> {
     ...
     * @param endTime
     */
    public ShopDiscount(ServerGlobals sGlobals, long id, int serverId, ShopType shopType,
                        int discount, int numMultiple, long startTime, long endTime) {
        this(sGlobals);
        this.id = id;
