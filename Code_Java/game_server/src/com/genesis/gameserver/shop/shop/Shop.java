...
public class Shop extends ObjectInSqlImpl<Long, ShopEntity> {
    ...
    public Shop(Human human, long id, ShopType shopType, Timestamp closeTime) {
        ...
        this.id = id;
        this.shopTemplate =
                GlobalData.getTemplateService().get(shopType.getIndex(), ShopTemplate.class);
    ...
    public ShopEntity toEntity() {
        ...
        entity.setManuallyRefreshCount(
                this.shopRefresh.getMauallyRefresh().getManuallyRefreshCount());
        entity.setLastResetManuallyRefreshCountTime(
                new Timestamp(this.shopRefresh.getMauallyRefresh().getLastExecuteTime()));
        entity.setLastAutoRefreshTime(
                new Timestamp(this.shopRefresh.getAutoRefresh().getLastExecuteTime()));
    ...
    public void fromEntity(ShopEntity entity) {
        ...
        this.shopTemplate =
                GlobalData.getTemplateService().get(entity.getShopType(), ShopTemplate.class);
        this.goodBornTime = entity.getGoodBornTime();
        this.goodList =
                Good.createGoodList(JSON.parseArray(entity.getGoodDataList(), GoodData.class),
                        this);
        this.shopRefresh = new ShopRefresh(this, human, entity.getManuallyRefreshCount(),
                entity.getLastResetManuallyRefreshCountTime(), entity.getLastAutoRefreshTime());
