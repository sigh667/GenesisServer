...
import com.genesis.gameserver.core.actor.ActorWrapper;
import com.genesis.gameserver.core.actor.PlayerActorWrapper;
...
public class ServerActorGlobals {
    ...
    private final ConcurrentHashMap<Long, PlayerActorWrapper> playerActors =
