...
import com.genesis.gameserver.hero.quality.QualityProp;
import com.genesis.gameserver.hero.skill.SkillManager;
import com.genesis.gameserver.hero.star.StarAndLevelProp;
...
public class Hero extends ObjectInSqlImpl<Long, HeroEntity> {
    ...
    /** 非战斗属性管理器 */
    private final EnumArray<HeroPropId, Long> prop =
            EnumArray.create(HeroPropId.class, Long.class, 0L);
    /** 战斗属性容器 */
    ...
    public static Hero buildFromHeroEntity(HeroEntity entity, Human owner) {
        ...
        HeroAttrTemplate template =
                GlobalData.getTemplateService().get(templateId, HeroAttrTemplate.class);
    ...
    private void giveDefaultValueOnBorn() {
        ...
        final HeroGroupTemplate heroGroupTemplate =
    ...
    public void qualityUp() {
        ...
        final HeroAttrTemplate nextTemplate =
                GlobalData.getTemplateService().get(nextId, HeroAttrTemplate.class);
    ...
    public void addExp(long exp) {
        ExpData expData = Globals.getExpService()
                .addExp(prop.get(HeroPropId.LEVEL), owner.get(HumanPropId.LEVEL),
    ...
    public boolean isExpAddable() {
        return Globals.getExpService()
                .isAddable(prop.get(HeroPropId.LEVEL), owner.get(HumanPropId.LEVEL),
                        prop.get(HeroPropId.EXP), ExpTemplate.ExpEnum.HERO);
    }
